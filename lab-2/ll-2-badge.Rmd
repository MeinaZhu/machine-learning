...
-   Yes. I am. It has pretty good prediction.

3.  How might the model be improved? Share any ideas you have at this time below:

-   I am not sure whether the accuracy could be improved further.
...
my_rec <- recipe(passing_grade ~ ., data = d) %>% 
    ...
    step_naomit(all_predictors()) %>% # remove all missing values mz
