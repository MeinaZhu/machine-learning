...
-   It is almost the same, but it is worth the investment.
...
-   The higher the Kappa, sensitivity, specificity, and roc, the more accuracy it is I guess.
...
```{r panel-chunk-1, echo = TRUE, eval = TRUE}
...
```{r panel-chunk-4b, echo = TRUE, eval = TRUE}
...
```{r panel-chunk-5, echo = TRUE, eval = TRUE}
# fit stats
final_fit %>%
    collect_metrics()
